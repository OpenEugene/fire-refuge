...
type AirtableData = {
  ...
  readonly Log: Maybe<Scalars['Float']>;
  readonly Address: Maybe<Scalars['String']>;
  readonly Directions: Maybe<Scalars['String']>;
  readonly County: Maybe<ReadonlyArray<Maybe<Airtable>>>;
  readonly Source: Maybe<Scalars['String']>;
  readonly Opened_Date: Maybe<Scalars['Date']>;
  readonly Managing_Agency: Maybe<Scalars['String']>;
  readonly Source_Last_Update: Maybe<Scalars['Date']>;
  readonly Last_Updated: Maybe<Scalars['Date']>;
  readonly Open: Maybe<Scalars['Int']>;
  readonly Closed_Date: Maybe<Scalars['Date']>;
  readonly Notes: Maybe<Scalars['String']>;
  readonly Hidden: Maybe<Scalars['Boolean']>;
  readonly Hours: Maybe<Scalars['String']>;
  readonly Alert_Link: Maybe<Scalars['String']>;
  readonly Shelter: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly Link: Maybe<Scalars['String']>;
  readonly Phone: Maybe<Scalars['String']>;
};


type AirtableData_Opened_DateArgs = {
...
type AirtableData_Source_Last_UpdateArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type AirtableData_Last_UpdatedArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type AirtableData_Closed_DateArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type AirtableDataFilterInput = {
  ...
  readonly Log: Maybe<FloatQueryOperatorInput>;
  readonly Address: Maybe<StringQueryOperatorInput>;
  readonly Directions: Maybe<StringQueryOperatorInput>;
  readonly County: Maybe<AirtableFilterListInput>;
  readonly Source: Maybe<StringQueryOperatorInput>;
  readonly Opened_Date: Maybe<DateQueryOperatorInput>;
  readonly Managing_Agency: Maybe<StringQueryOperatorInput>;
  readonly Source_Last_Update: Maybe<DateQueryOperatorInput>;
  readonly Last_Updated: Maybe<DateQueryOperatorInput>;
  readonly Open: Maybe<IntQueryOperatorInput>;
  readonly Closed_Date: Maybe<DateQueryOperatorInput>;
  readonly Notes: Maybe<StringQueryOperatorInput>;
  readonly Hidden: Maybe<BooleanQueryOperatorInput>;
  readonly Hours: Maybe<StringQueryOperatorInput>;
  readonly Alert_Link: Maybe<StringQueryOperatorInput>;
  readonly Shelter: Maybe<StringQueryOperatorInput>;
...
enum AirtableFieldsEnum {
  ...
  data___Lat = 'data.Lat',
  data___Log = 'data.Log',
  data___Address = 'data.Address',
  data___Directions = 'data.Directions',
  data___County = 'data.County',
  data___County___id = 'data.County.id',
  data___County___parent___id = 'data.County.parent.id',
  data___County___parent___children = 'data.County.parent.children',
  data___County___children = 'data.County.children',
  data___County___children___id = 'data.County.children.id',
  data___County___children___children = 'data.County.children.children',
  data___County___internal___content = 'data.County.internal.content',
  data___County___internal___contentDigest = 'data.County.internal.contentDigest',
  data___County___internal___description = 'data.County.internal.description',
  data___County___internal___fieldOwners = 'data.County.internal.fieldOwners',
  data___County___internal___ignoreType = 'data.County.internal.ignoreType',
  data___County___internal___mediaType = 'data.County.internal.mediaType',
  data___County___internal___owner = 'data.County.internal.owner',
  data___County___internal___type = 'data.County.internal.type',
  data___County___table = 'data.County.table',
  data___County___recordId = 'data.County.recordId',
  data___County___data___Name = 'data.County.data.Name',
  data___County___data___Lat = 'data.County.data.Lat',
  data___County___data___Log = 'data.County.data.Log',
  data___County___data___Address = 'data.County.data.Address',
  data___County___data___Directions = 'data.County.data.Directions',
  data___County___data___County = 'data.County.data.County',
  data___County___data___Source = 'data.County.data.Source',
  data___County___data___Opened_Date = 'data.County.data.Opened_Date',
  data___County___data___Managing_Agency = 'data.County.data.Managing_Agency',
  data___County___data___Source_Last_Update = 'data.County.data.Source_Last_Update',
  data___County___data___Last_Updated = 'data.County.data.Last_Updated',
  data___County___data___Open = 'data.County.data.Open',
  data___County___data___Closed_Date = 'data.County.data.Closed_Date',
  data___County___data___Notes = 'data.County.data.Notes',
  data___County___data___Hidden = 'data.County.data.Hidden',
  data___County___data___Hours = 'data.County.data.Hours',
  data___County___data___Alert_Link = 'data.County.data.Alert_Link',
  data___County___data___Shelter = 'data.County.data.Shelter',
  data___County___data___Link = 'data.County.data.Link',
  data___County___data___Phone = 'data.County.data.Phone',
  data___Source = 'data.Source',
  data___Opened_Date = 'data.Opened_Date',
  data___Managing_Agency = 'data.Managing_Agency',
  data___Source_Last_Update = 'data.Source_Last_Update',
  data___Last_Updated = 'data.Last_Updated',
  data___Open = 'data.Open',
  data___Closed_Date = 'data.Closed_Date',
  data___Notes = 'data.Notes',
  data___Hidden = 'data.Hidden',
  data___Hours = 'data.Hours',
  data___Alert_Link = 'data.Alert_Link',
  data___Shelter = 'data.Shelter',
  data___Link = 'data.Link',
  data___Phone = 'data.Phone'
}
...
type AirtableFilterListInput = {
  readonly elemMatch: Maybe<AirtableFilterInput>;
};
...
enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___tables___tableLinks = 'pluginCreator.pluginOptions.tables.tableLinks',
  pluginCreator___pluginOptions___tables___tableView = 'pluginCreator.pluginOptions.tables.tableView',
  ...
  pluginCreator___pluginOptions___modules = 'pluginCreator.pluginOptions.modules',
  ...
  pluginCreator___pluginOptions___onlyRemoveTypeImports = 'pluginCreator.pluginOptions.onlyRemoveTypeImports',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___tables___tableLinks = 'pluginOptions.tables.tableLinks',
  pluginOptions___tables___tableView = 'pluginOptions.tables.tableView',
  ...
  pluginOptions___modules = 'pluginOptions.modules',
  ...
  pluginOptions___onlyRemoveTypeImports = 'pluginOptions.onlyRemoveTypeImports',
...
type SitePluginPluginOptions = {
  ...
  readonly onlyRemoveTypeImports: Maybe<Scalars['Boolean']>;
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly onlyRemoveTypeImports: Maybe<BooleanQueryOperatorInput>;
...
type SitePluginPluginOptionsTables = {
  ...
  readonly tableLinks: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly tableView: Maybe<Scalars['String']>;
};
...
type SitePluginPluginOptionsTablesFilterInput = {
  ...
  readonly tableLinks: Maybe<StringQueryOperatorInput>;
  readonly tableView: Maybe<StringQueryOperatorInput>;
};
...
type usersgregcodeopenEugenefireRefugesrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type usersgregcodeopenEugenefireRefugesrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };

type usersgregcodeopenEugenefireRefugesrccomponentsseoJs63159454QueryVariables = Exact<{ [key: string]: never; }>;


type usersgregcodeopenEugenefireRefugesrccomponentsseoJs63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };

type shelterQueryQueryVariables = Exact<{ [key: string]: never; }>;


type shelterQueryQuery = { readonly allAirtable: { readonly nodes: ReadonlyArray<{ readonly data: Maybe<(
        Pick<AirtableData, 'Address' | 'Alert_Link' | 'Directions' | 'Lat' | 'Log' | 'Name' | 'Phone'>
        & { readonly County: Maybe<ReadonlyArray<Maybe<{ readonly data: Maybe<Pick<AirtableData, 'Name'>> }>>> }
      )> }> } };
...
type usersgregcodeopenEugenefireRefugesrccomponentsimageJs1132682437QueryVariables = Exact<{ [key: string]: never; }>;


type usersgregcodeopenEugenefireRefugesrccomponentsimageJs1132682437Query = { readonly placeholderImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };
